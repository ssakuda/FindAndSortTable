...
Most of what you will need is under the module ConfigureUserSettings. If you enable the custom sorts, you will need to write your own code. SortBomCustom() comes with sample code to give some ideas about how to approach applying custom sort criteria.
